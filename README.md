...
```bash
java -jar target/tcpmon-tls-0.6.15.jar
```
...
```bash
java -jar target/tcpmon-tls-0.6.15.jar --init-config tcpmon.json
# or
java -jar target/tcpmon-tls-0.6.15.jar --init-config tcpmon.yaml
```

Start with a config file:

```bash
java -jar target/tcpmon-tls-0.6.15.jar --config tcpmon.json
```
